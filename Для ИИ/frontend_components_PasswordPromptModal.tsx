      ...
      <div className="p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 pt-2">
            <button type="button" onClick={onClose} className="flex-1 py-3.5 rounded-2xl font-bold transition-all bg-white/20 dark:bg-white/5 hover:bg-white/30 dark:hover:bg-white/10 border border-white/30 dark:border-white/10 shadow-sm cursor-pointer">
              Отмена
            </button>
            <button type="submit" disabled={!password || isLoading} className="flex-1 py-3.5 bg-lime-400 hover:bg-lime-500 text-black rounded-2xl font-bold transition-all border border-lime-300 shadow-[0_0_20px_rgba(163,230,53,0.4)] disabled:opacity-50 flex items-center justify-center cursor-pointer">
