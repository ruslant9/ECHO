  ...
  return (
    <LiquidGlassModal isOpen={isOpen} onClose={onClose} maxWidth="max-w-md">
      ...
      <div className="p-6 border-t border-white/20 dark:border-white/10 flex gap-4 bg-white/5 dark:bg-black/20">
        <button 
          onClick={onClose} 
          className="flex-1 py-3.5 rounded-2xl font-bold transition-all bg-white/20 dark:bg-white/5 hover:bg-white/30 dark:hover:bg-white/10 border border-white/30 dark:border-white/10 shadow-sm cursor-pointer"
        >
          Отмена
        </button>
        <button 
