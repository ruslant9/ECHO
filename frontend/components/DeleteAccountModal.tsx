          ...
          <form onSubmit={handleTextConfirm} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full p-4 rounded-2xl bg-black/20 border border-white/20 outline-none focus:border-red-400 placeholder:text-white/30 transition-colors font-bold tracking-widest text-center"
              />
            </div>

            <div className="flex gap-3 pt-2">
              <button type="button" onClick={onClose} className="flex-1 py-3.5 rounded-2xl font-bold bg-white/10 hover:bg-white/20 border border-white/10 transition-all">
                Отмена
              </button>
